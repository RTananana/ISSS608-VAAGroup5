...
In this project, we will adopt the measures of (1) Accuracy, (2) Confusion Matrix, and (3) F1 Score to evaluate the performance of our predictive model. 

Overall, a good predictive model should have high accuracy, F1-score, and a well-balanced confusion matrix and classification report. However, the choice of metrics may depend on the specific problem and the nature of the data. It is important to choose the right metrics to accurately evaluate a model's performance. 
